...
export async function POST(req: Request) {
  try {
    ...
    await sb.from("admin_audit_log").insert({ actor_user_id: row.user_id, action: "activate_account", target_user_id: row.user_id, meta: {} });
    ...
    return jsonErrorCompat("Erro inesperado na ativação.", 500, { code: "internal_error", extra: { details: msg } });
  }
}
